...
function Placements() {
  ...
  return (
    <div className="placement-glory-container">
      ...
      <div className="pg-container">
        <div className="pg-content-grid">
          <div className="pg-narrative-text">
            ...
            <p>
              As hard as it might be to imagine sometimes, there is life after JEC, as shown by the <strong>~10,000+ JEC alumni</strong> living around the world. Jaipur Engineering College (JEC) is making new strides in placements of its students in top notch brands every year.
            </p>
            <p>
              For the last three years, JEC has set the highest placement record, and the academic year 2021-25 too proved no different. Crossing the mark of expected placement drives & offers, this year proved job-productive for JEC students not only in number but quality placement also.
            </p>
            <p>
              Presently JEC students are working world-wide with prestigious global companies like Google, Microsoft, Apple, Amazon, Infosys, Triumph, Cape Electric and many more. JEC is closely associated with a few brands. These brands consider JEC as ‘One Stop Solution’ for industry ready human resource.
            </p>
          ...
          <div>
            ...
            <img 
              ...
              style={{ width: '100%', borderRadius: '12px', boxShadow: 'var(--shadow-card)' }} 
        ...
        <div className="pg-achievers-grid" id="studentGrid">
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/1.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Junhaid Khan</div><div className="pg-ac-comp">Jakson Green Pvt. Ltd.</div><div className="pg-ac-pkg">20.40 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/2.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Dashrath Singh Kavia</div><div className="pg-ac-comp">SalesForce</div><div className="pg-ac-pkg">19 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/3.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Gaurav Verma</div><div className="pg-ac-comp">Technip Energies</div><div className="pg-ac-pkg">17 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/4.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Yashmit Sharma</div><div className="pg-ac-comp">Synopsys, Inc.</div><div className="pg-ac-pkg">15.3 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/5.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Piyush Rajliwal</div><div className="pg-ac-comp">BOSCH Jaipur</div><div className="pg-ac-pkg">12 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/6.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Ramkishan</div><div className="pg-ac-comp">EoxysiIT</div><div className="pg-ac-pkg">12 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/men/7.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Kshitij Mathur</div><div className="pg-ac-comp">HabileLabs Pvt Ltd</div><div className="pg-ac-pkg">12 LPA</div></div>
          <div className="pg-achiever-card premium"><img src="https://randomuser.me/api/portraits/women/8.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Aishwarya</div><div className="pg-ac-comp">BuildMart PVT. LTD.</div><div class="pg-ac-pkg">10 LPA</div></div>
          ...
          <div className="pg-achiever-card"><img src="https://randomuser.me/api/portraits/men/10.jpg" className="pg-student-img" alt="" /><div className="pg-ac-name">Shivam Shekhar Jha</div><div class="pg-ac-comp">WHITEHAT JR</div><div className="pg-ac-pkg">9.5 LPA</div></div>
        ...
        <div className="pg-section-header">
          ...
          <div className="pg-section-line" style={{ maxWidth: '200px', margin: '10px auto', height: '4px', background: 'var(--gold)' }}></div>
        </div>
